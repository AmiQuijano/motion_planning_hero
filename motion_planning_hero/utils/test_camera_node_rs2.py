...
class CameraRecorder2(Node):
    def __init__(self, camera_recorder_config2=None):
        ...
        self.serial_number = self.camera_recorder_cfg["serial_number"]
        ...
        # Start Realsense
        self.realsense_data = RealsenseDataloader(clipping_distance_m=clipping_distance, serial_number=self.serial_number)
